<template>
  <div class="text-center about" style="margin-top: 7%;">
    <div v-if="visaCounter == 0">
      <h3>Add Card</h3>
      <p>Add a credit card to your wallet
        for a smooth and fast payment experience</p>
      <img src="@/assets/img/visa.svg" alt="" class="img-fluid">
      <h3>Click here to add your credit card</h3>

      <button class="btn btn-next m-auto rounded-circle d-block mt-4" style="width: 50px; height: 50px;"
        @click.prevent="visaCounter++">+</button>
    </div>
    <div v-if="visaCounter == 1">
      <button class="btn float-left" @click.prevent="visaCounter--"><i class="fa-solid fa-arrow-left"></i></button>
      <h3>Add Card</h3>
      <p>Add a credit card to your wallet
        for a smooth and fast payment experience</p>
                ...
                <div class="card-item__wrapper">
                  ...
                  <div class="card-item__content">
                    ...
                    <div class="card-item__date" ref="cardDate">
                      ...
                      <label for="cardMonth" class="card-item__dateItem" style="margin-right:14%;">
                        <transition name="slide-fade-up">
